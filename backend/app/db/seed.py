...
CATEGORIES = [
    ("стипендія", "Академічні та соціальні стипендії, рейтинги, виплати.", "Відділ стипендіального забезпечення"),
    ("гуртожиток / проживання", "Поселення, проживання, побут, ремонт, оплата гуртожитку.", "Студмістечко КПІ ім. Ігоря Сікорського"),
    ("вступ", "Вступна кампанія, правила прийому, документи вступника, підготовчі курси для абітурієнтів.", "Приймальна комісія КПІ ім. Ігоря Сікорського"),
    ("навчальний процес", "Розклад, сесія, практики, атестація, загальні правила освітнього процесу.", "Департамент організації освітнього процесу"),
    ("деканат / довідки студентів", "Довідки про навчання, денна форма, довідки для роботодавця, індивідуальні заяви.", "Деканат або дирекція факультету / інституту"),
    ("документи про освіту", "Дипломи, додатки до дипломів, дублікати, апостиль, довідки про справжність документів про освіту.", "Відділ супроводження документів здобувачів вищої освіти"),
    ("переведення / поновлення / відрахування", "Поновлення, переведення, академвідпустка, відрахування, зміна форми навчання.", "Деканат або дирекція факультету / інституту"),
    ("академічна мобільність", "Програми обміну, Erasmus, learning agreement, стажування.", "Відділ академічної мобільності"),
    ("соціальна / психологічна підтримка", "Психологічна допомога, соціальний супровід, складні життєві обставини.", "Відділ соціально-психологічної роботи - Студентська соціальна служба"),
    ("мережа / пошта / інтернет", "Wi-Fi, інтернет, мережа, VPN, Moodle-доступ, корпоративна пошта, телекомунікаційні сервіси.", "Центр телекомунікацій КПІ-Телеком"),
    ("Електронний кампус", "Вхід, пароль, куратор групи, ролі, оцінки, журнал та помилки Електронного кампусу.", "Служба підтримки Електронного кампусу / КБІС"),
    ("бібліотека", "Бібліотечні послуги, електронні ресурси, Scopus, Web of Science, каталог, читацький квиток.", "Науково-технічна бібліотека ім. Г. І. Денисенка"),
    ("міжнародні студенти", "Питання іноземних студентів, посвідки, зміна паспорта, запрошення, легалізація.", "Центр міжнародної освіти"),
    ("безпека / перепустки", "Пропускний режим, перепустки, доступ до корпусів, інциденти.", "Департамент безпеки"),
    ("оплата навчання / фінанси", "Оплата навчання, контракт, рахунки, борги, платіжні документи.", "Управління бухгалтерського обліку та звітності"),
    ("інше / первинна маршрутизація", "Змішані, нестандартні або недостатньо визначені звернення: КПІ-стікери, екскурсії, загальні пропозиції, акредитаційні довідки про університет.", "Загальна довідкова служба КПІ"),
]
...
async def seed_catalog() -> None:
    async with AsyncSessionLocal() as db:
        ...
        obsolete_categories = await db.scalars(select(Category).where(~Category.name.in_(desired_category_names)))
        for category in obsolete_categories:
            await db.delete(category)

        obsolete_departments = await db.scalars(select(Department).where(~Department.name.in_(desired_department_names)))
